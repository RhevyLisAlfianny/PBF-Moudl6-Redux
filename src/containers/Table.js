...
import { 
    SHOW_ALL, 
    SHOW_COMPLETED, 
    SHOW_ACTIVE } from "../actions/actionsTypes";
                        ...
                        <tbody>
                            {this.props.todos.map(todo => (
                                <tr key={todo.id}>  
                                    ...
                                    <td>
                                    <button type="button" onClick={() => this.props.deleteTodo(todo.id)} 
                                        style={{marginTop: "25px", marginRight: "20px"}} className="btn btn-danger">
                                        Delete</button>
                                    <button type="button" onClick={() => this.props.toggleTodo(todo.id)} 
                                        style={{marginTop: "25px"}} className="btn btn-success">
                                        check</button>
                                    </td>
                                </tr>
                            ))}
